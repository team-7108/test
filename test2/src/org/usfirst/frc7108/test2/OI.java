...
public class OI {
    ...
    public OI() {
        ...
        joystickButton3.whenPressed(new PneuForward());
        joystickButton2 = new JoystickButton(joystick1, 2);
        joystickButton2.whenPressed(new PneuReverse());
        ...
        joystickButton4.whileHeld(new OpenGrabber());
        joystickButton1 = new JoystickButton(joystick1, 1);
        joystickButton1.whenPressed(new DisarmGrabber());
        ...
        SmartDashboard.putData("DisarmGrabber", new DisarmGrabber());
        SmartDashboard.putData("UseClimber", new UseClimber());
        SmartDashboard.putData("PneuForward", new PneuForward());
        SmartDashboard.putData("PneuReverse", new PneuReverse());
